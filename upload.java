...
public class upload extends HttpServlet {
	...
	final String filepath="C:\\Users\\kondr\\OneDrive\\Desktop\\Secure Deduplication\\";
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			String[] fileblocks=request.getParameterValues("content");
			
			for(String blockData : fileblocks)
			{	
				System.out.println("6 :\t"+blockData);
				...
				if(blockId==0)
				{
					...
					String fileName="C:\\Users\\kondr\\OneDrive\\Desktop\\Secure Deduplication\\"+newBlockID+".txt";
